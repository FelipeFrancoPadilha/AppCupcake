        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 border border-pink-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="additional-info" className="text-sm font-bold text-gray-700 block mb-1">Informações Adicionais (Opcional)</label>
                <textarea 
                  id="additional-info" 
                  name="additional-info" 
                  rows={3} 
                  className="w-full px-4 py-2 bg-rose-50/50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-500" 
                  placeholder="Ex: Deixar na portaria, campainha quebrada, etc."
                ></textarea>
              </div>
